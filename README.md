...
选中网页里的英文单词，点右键，再点击“把这个词加入我的词库”。加入后，它会在网页中高亮。

![选中网页生词并通过右键加入词库](docs/showcase/add-word.gif)

### 2. 反复点读，自动排到前面

点击黄色单词会播放发音，点读次数同时加一。你越常点一个词，它越会排到右上角词库的前面。

![反复点读的单词逐步升到词库排行第一](docs/showcase/point-read-ranking.gif)

### 3. 记住一个，下一批自然顶上来

Mac 按住 `Option` 点击高亮词，Windows 按住 `Alt` 点击。确认“记住了”后，这个词退出当前排行，后面的生词自动补上来。
